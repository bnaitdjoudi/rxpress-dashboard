...
const LoginBoxed = () => {
    ...
    return (
        <div>
            ...
            <div className="relative flex min-h-screen items-center justify-center bg-[url(/assets/images/auth/map.png)] bg-cover bg-center bg-repeat px-6 py-10 dark:bg-[#060818] sm:px-16">
