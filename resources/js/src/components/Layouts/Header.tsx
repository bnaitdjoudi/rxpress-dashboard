...
import profileApi, { UserWithProfile } from '../../services/profile.service';
...
const Header = () => {
    ...
    // Ajout récupération profil utilisateur connecté
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">rxpress</span>
                        </Link>
                        <button
                            type="button"
                    ...
                    <div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
                        ...
                        <div className="dropdown shrink-0 hidden">
                            <Dropdown
                                offset={[0, 8]}
                                placement={`${isRtl ? 'bottom-start' : 'bottom-end'}`}
                                btnClassName="block p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60"
                        ...
                        <div className="dropdown shrink-0 flex">
                            <Dropdown
                                ...
                                button={
                                    user?.profile?.avatar ?
                                        <img className="w-9 h-9 rounded-full object-cover saturate-50 group-hover:saturate-100" src={user?.profile?.avatar || '/assets/images/user-profile.jpeg'} alt="userProfile" />
                                        : (<div className="w-9 h-9 rounded-full bg-primary/20 flex items-center justify-center text-2xl font-bold text-primary shrink-0">
                                ...
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            ...
                                            {
                                                user?.profile?.avatar ?
                                                    <img className="w-10 h-10 rounded-md object-cover saturate-50 group-hover:saturate-100" src={user?.profile?.avatar || '/assets/images/user-profile.jpeg'} alt="userProfile" />
                                                    : (<div className="w-10 h-10   rounded-md bg-primary/20 flex items-center justify-center text-2xl font-bold text-primary shrink-0">
                                                        {user?.name?.charAt(0).toUpperCase() || '?'}
                                                    </div>)
                                            }
