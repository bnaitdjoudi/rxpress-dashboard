...
const routes = [
    // Paiement Stripe — pages de retour
    {
    ...
    {
        path: '/subscriptions',
        element: <AuthGuard><Subscription /></AuthGuard>,
    },
    // dashboard
    {
        path: '/',
    ...
    {
        path: '/sites',
        element: <AuthGuard><Sites /></AuthGuard>,
    },
    {
        path: '/sites/:id',
        element: <AuthGuard><Sites /></AuthGuard>,
    ...
    {
        path: '/wp-hooks',
        element: <AuthGuard><WpHooks /></AuthGuard>,
    },
    {
        path: '/sites/:id/wp-hooks',
        element: <AuthGuard><WpHooks /></AuthGuard>,
    },
    {
        path: '/wp-events',
        element: <AuthGuard><WpEvents /></AuthGuard>,
    },
    {
        path: '/webhook-deliveries',
        element: <AuthGuard><WebhookDeliveries /></AuthGuard>,
    },
    // {
    //     path: '/index',
    //     element: <Index />,
